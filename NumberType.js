...
function numbertype(num){
    if (num > 0)
        console.log("Given number "+ num +" is Positive" + " and the type is " + typeof num)
    else if(num < 0)
     console.log("Given number "+ num +" is Negative"+ " and the type is " + typeof num)
    else
        console.log("Given number "+ num +" is zero" + " and the type is " + typeof num)
}
numbertype(3)
